...
def frequent_subgraphs_builder(class_name):
...
def equivalence_classes_builder(class_name, frequent_subgraphs):
    prefix = 'example_graphs'
...
if __name__ == "__main__":
    ...
    for c in classes:
        frequent_subgraphs = frequent_subgraphs_builder(c)
        graph_patterns_builder(c, frequent_subgraphs)
        equivalence_classes_builder(c, frequent_subgraphs)
        print(f"{c} finished.")
